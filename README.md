...
- Реализация бизнес-логики на основании chain-of-responsibility
- Интеграция с Postgre (Jooq )
- Реализация gradle Tasks для самостоятельной генерации описания БД
- Интеграция с TestContainers
- Упаковка решения в контейнеры
- Реализация отдельного хранилища изображений. Интеграция с Мinio
- Интеграция с транспортом Kafka
- Логи envoy парсить в OpenSearch
- Логи Minio в OpenSearch
- Реализовать сборку с помощью GitHub
- Swagger-UI. Подключить к проекту
